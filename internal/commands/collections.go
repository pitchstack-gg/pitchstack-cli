...
func newCollectionsCommand() *cli.Command {
	return &cli.Command{
		...
		Commands: []*cli.Command{
			...
			newResourceLikeCommand("collection", clientv1.LikeableResourceTypeCollection),
			newResourceUnlikeCommand("collection", clientv1.LikeableResourceTypeCollection),
			newResourceTrendingCommand("collections", clientv1.TrackableResourceTypeCollection),
