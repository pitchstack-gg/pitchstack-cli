...
func newDecksCommand() *cli.Command {
	return &cli.Command{
		...
		Commands: []*cli.Command{
			...
			newResourceLikeCommand("deck", clientv1.LikeableResourceTypeDeck),
			newResourceUnlikeCommand("deck", clientv1.LikeableResourceTypeDeck),
			newResourceTrendingCommand("decks", clientv1.TrackableResourceTypeDeck),
